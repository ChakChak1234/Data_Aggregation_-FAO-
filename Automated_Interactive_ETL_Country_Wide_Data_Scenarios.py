...
# Future List
Future_List = ["2020s", "2050s"]

# Climate Model/Scenario List
Climate_Model_List = ["CCCma CGCM2 A2", "CCCma CGCM2 B2", "CSIRO Mk2 A2", "CSIRO Mk2 B1", "CSIRO Mk2 B2", "MPI ECHAM4 A2",
                 "MPI ECHAM4 B2", "Hadley CM3 A1FI", "Hadley CM3 A2", "Hadley CM3 B1", "Hadley CM3 B2"]
...
to_loop = itertools.product(AgroEcological_Suitability_and_Productivity_List, Crop_List, Water_Supply_List, Input_Level_List,
                            Future_List, Climate_Model_List)
...
for i in to_loop:
    ...
    newfilename = country + Crop + Water_Supply + Input_Level + AES_and_P + Future_List + Climate_Model_List + Fertilization_Response
